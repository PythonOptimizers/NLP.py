...
class TestAugmentedLagrangianScipyAmplModelHS7(AugmentedLagrangianHS7, TestCase):
...
class TestAugmentedLagrangianScipyAmplModelHS10(AugmentedLagrangianHS10, TestCase):
