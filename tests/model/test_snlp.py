...
from nlpy.model.cysparsemodel import CySparseAmplModel, CySparseSlackModel
from nlpy.model.pysparsemodel import PySparseAmplModel, PySparseSlackModel
from helper import *
import numpy as np
import os
...
class Test_SlackModelPySparseAmplHS7(TestCase, Hs7):    # Test defined in Hs7
    ...
    def setUp(self):
        ...
        nlp = PySparseAmplModel(model)
        nlp.pi0 = np.ones(1)
        self.nlp = PySparseSlackModel(nlp)    # x0 = (2, 2)
...
#     def setUp(self):
#         model = os.path.join(this_path, 'hs007.nl')
#         nlp = CySparseAmplModel(model)
#         nlp.pi0 = np.ones(1)
#         self.nlp = CySparseSlackModel(nlp)    # x0 = (2, 2)
