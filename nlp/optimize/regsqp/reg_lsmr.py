...
class RegLSMRFramework(KrylovMethod):
    ...
    def solve(self, b, damp=0.0, atol=1e-9, btol=1e-9, conlim=1e8, gamma=1e-9, mu=1e-10,
            ...
            :istop: int
                ...
                istop   = 0 means x=0 is a solution.
                        ...
                        = 8 means that the truncated direct error estimate is
                            sufficiently small.
                        = 9 inner iteration test
                        = 10 outer iteration test
            :itn: int
        ...
        if show:
            ...
            print 'LSMR finished'
            print msg[istop]
            str1 = 'istop =%8g    normb =%8.1e  normr  =%8.1e' % (istop,
                                                                  normb,
                                                                  normr)
            str2 = ' ' * 19 + 'normA =%8.1e  normAr =%8.1e' % (normA, normar)
